                ...
                <table class="table table-hover">
                    ...
                    <?php foreach($cours as $cour):?>
                        <tr>
                            ...
                            <td>
                                <?php if($cour['absence_done']== 1 ):?>
                                    <a href="#" >
                                        <button class="btn btn-outline-warning"  > Absence Déja Marque </button>
                                    </a>
                                <?php else: ?>
                                    <a href="<?=path('absence/marquer/'),$cour["id_cours"]?>">
                                        <button class="btn btn-outline-info"  type="submit"> Marquer Absence </button>
                                    </a>
                                <?php endif; ?>
                            </td>
                        </tr>
